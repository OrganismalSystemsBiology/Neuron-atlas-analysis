...
from HalfBrainCells_NeuN import HalfBrainCells
...
class WholeBrainImages(object):
    ...
    def precompute_param_header(self, is_FW):
        ...
        param_dict = {
            ...
            "downscale_ratio_80": down_scale_xyz,
...
class WholeBrainCells(object):
    ...
    def scalemerge(self):
        ...
        def process_stack(dst_path, cellstack, bound_z, margin_left, margin_top,
            ...
            centroid_scaled[:,0] = (cellstack.data_global["merged_x"] - offset_x) * coeff_x 
            centroid_scaled[:,1] = (cellstack.data_global["merged_y"] - offset_y) * coeff_y 
        ...
        for xyname,cellstack in cellstacks_FW.items():
            ...
            dst_path = os.path.join(dst_basedir_FW, "{}_{}.bin".format(xyname[1],xyname[0]))
            num_cells = process_stack(dst_path, cellstack,
                                      ...
                                      1/param_scalemerge_FW["downscale_ratio_80"],
                                      1/param_scalemerge_FW["downscale_ratio_80"],
                                      1/param_scalemerge_FW["downscale_ratio_80"],
                                      A_FW, b_FW)
        ...
        for xyname,cellstack in cellstacks_RV.items():
            ...
            num_cells = process_stack(dst_path, cellstack,
                                      ...
                                      1/param_scalemerge_RV["downscale_ratio_80"],
                                      1/param_scalemerge_RV["downscale_ratio_80"],
                                      1/param_scalemerge_RV["downscale_ratio_80"],
