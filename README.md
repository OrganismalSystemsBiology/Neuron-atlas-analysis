...
- **Averaged template images** for cell density (cell nuclei or neurons), compatible with the Allen Brain Atlas (10 µm scale):  
  `"/Neurology/Neuron_Atlas/iso_50um_R_ver4_nuclear_with_ventricle.tif"` or  
...
1. **Cell Digitization (using 10x high-resolution light-sheet imaging data)**  
   ...
   - **(1-6) Creating a 50 µm Voxel Cell Density Image**  
...
1. **Aβ Deposition Extraction (using 1x low-resolution light-sheet imaging data)**  
   **Notebook:**  
     ```
